...
{{
  ...
  "bible_refs": [
    {{
      "ref": "Книга глава:стих — ОБЯЗАТЕЛЬНО указывай конкретный стих! Формат: 'Бытие 3:15' или 'Римлянам 8:18-25'. Никогда не пиши просто главу без стиха (не 'Бытие 3'!). Название в именительном падеже: Иоанн, Матфей, Лука, Римлянам, Псалтирь, 1 Коринфянам. ПСАЛТИРЬ: самый длинный псалом = 118 (176 стихов). Пс 118:105 = 'Слово Твое светильник'. НЕ ПУТАЙ: Пс 119 — короткий (7 стихов)!",
